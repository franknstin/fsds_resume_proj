...
from housing.entity.config_entit import *
...
class Configuration:
    ...
    def ger_model_evlauation_config(self) -> ModelEvaluationConfig:
        try:
            pass
        except Exception as e:
            raise HousingException(e,sys) from e
    ...
    def get_training_pipeline_config(self) ->TrainingPipelineConfig:
        try:
            traingin_pipeline_config = self.config_info[TRAINING_PIPELINE_CONFIG_KEY]
            artifact_dir = os.path.join(ROOT_DIR, traingin_pipeline_config[TRAINING_PIPELINE_NAME_KEY],
                                        traingin_pipeline_config[TRAINING_PIPELINE_ARTIFACT_DIR_KEY])
            taining_pipeline_config = TrainingPipelineConfig(artifact_dir=artifact_dir)
            logging.info(f"training pipeline config: {traingin_pipeline_config}")
            return traingin_pipeline_config
